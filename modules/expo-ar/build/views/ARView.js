...
import { AppState, findNodeHandle, PixelRatio, Platform, } from 'react-native';
import uuidv4 from 'uuid/v4';
import { GLView } from 'expo-gl';
import { TrackingConfiguration, } from '../enums';
import { startAsync, isAvailable, stopAsync, } from '../functions';
export default class ARView extends React.Component {
    constructor() {
        ...
        this.onContextCreate = async (gl) => {
            ...
            if (isAREnabled) {
                // Start AR session
                await startAsync(findNodeHandle(this.nativeRef), ARTrackingConfiguration);
            }
