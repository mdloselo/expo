...
MAJOR_ABI_VERSION=${ORIGINAL_ABI_VERSION%%.*}
...
sed -i '' "s/\ \ \ \ $BACK_BUTTON_HANDLER_CLASS/\ \ \ \ \/\/ BEGIN_SDK_$MAJOR_ABI_VERSION$NEWLINE\ \ \ \ $ABI_VERSION.$BACK_BUTTON_HANDLER_CLASS,$NEWLINE\ \ \ \ \/\/ END_SDK_$MAJOR_ABI_VERSION$NEWLINE\ \ \ \ $BACK_BUTTON_HANDLER_CLASS/" expoview/src/main/java/host/exp/exponent/experience/MultipleVersionReactNativeActivity.java
